...
class NeRFRenderer(nn.Module):
    ...
    #def render(self, rays_o, rays_d, cam_id = None, staged=False, max_ray_batch=4096, **kwargs):新增1
        # rays_o, rays_d: [B, N, 3], assumes B == 1
        # return: pred_rgb: [B, N, 3]
    def render(self, rays_o, rays_d, cam_id=None, staged=False, max_ray_batch=4096,
        ...
        if staged and not self.cuda_ray:
            ...
            #results = _run(rays_o, rays_d, cam_id=cam_id, **kwargs)新增1
            results = _run(rays_o, rays_d, cam_id=cam_id, return_intermediates=return_intermediates, **kwargs)
